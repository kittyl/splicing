...
support=/SAN/vyplab/IoN_RNAseq/MEF/processed/sgseq/mef_m323k_sgseq_support.tab
code=M323K_MEF
outputDir=/SAN/vyplab/IoN_RNAseq/MEF/processed/sgseq/
clusterDir=/SAN/vyplab/IoN_RNAseq/MEF/processed/sgseq/cluster/
